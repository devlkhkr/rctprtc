                ...
                <table className="table_type_01">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>클라이언트 명</th>
                            <th className="tal">프로젝트 명 및 담당업무</th>
                            <th>사용 언어 및 개발 방식</th>
                            <th>프로젝트 위치</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>아모레퍼시픽</td>
                            <td className="tal">오설록 웹사이트 선물하기, 선물 수령 디자인 및 퍼블리싱</td>
                        ...
                        <tr>
                            ...
                            <td>코리안리</td>
                            <td className="tal">해외총판결제시스템 디자인, 퍼블리싱 및 프론트 영역 개발, 운영</td>
                            <td>Spring Framework 내 JSP(HTML), CSS, Javascript를 통한 화면 구현</td>
                            <td>종각 코리안리빌딩</td>
                        </tr>
                        <tr>
                            ...
                            <td>SK매직</td>
                            <td className="tal">SK매직스쿨 웹앱 전체페이지(FO, BO) 퍼블리싱 및 프론트 영역 구축</td>
                            <td>Spring Framework 내 JSP(HTML), CSS, Javascript를 통한 화면 구현</td>
                            <td>서울역 연세 세브란스빌딩</td>
                        </tr>
                        <tr>
                            ...
                            <td>SK매직</td>
                            <td className="tal">SK매직 서비스센터 모바일 웹앱 전체페이지(FO, BO) 퍼블리싱 및 프론트 영역 구축</td>
                            <td>Spring Framework 내 JSP(HTML), CSS, Javascript를 통한 화면 구현</td>
                            <td>서울역 대우재단빌딩</td>
                        </tr>
                        <tr>
                            ...
                            <td>삼성닷컴</td>
                            <td className="tal">삼성닷컴 홈피트니스 서비스 내, '트레이너리스트', '상품상세', '라운지', '나의구독상품', '전체 페이지 팝업 가이드' 파블리싱 및 프론트 작업</td>
                        ...
                        <tr>
                            ...
                            <td className="tal">Valex Service 직원 및 사업장 관리 시스템 전체 페이지 퍼블리싱 및 프론트 작업</td>
                        ...
                        <tr>
                            ...
                            <td>SK매직 카탈로그웹</td>
                            <td className="tal">SK매직 카탈로그 전체 페이지 퍼블리싱 및 프론트 작업</td>
                            <td>vue.js Framework 내 vue, SCSS, javascript를 통한 화면 구현</td>
                            <td>종각 삼일빌딩</td>
                        </tr>
                        <tr>
                            ...
                            <td className="tal">코리안리 프라이싱툴 시스템 전체 페이지 퍼블리싱 및 프론트 작업</td>
